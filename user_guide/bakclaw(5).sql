...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 11, 2018 at 08:47 AM
...
(11, 1, '3343', 'ប្រុស', '43', 1, NULL, 'គាត់', 0, NULL, 0),
...
(17, 1, 'គុង', 'ស្រី', '34', 0, NULL, '', 1, NULL, 1),
(18, 1, '345345', 'ស្រី', '54', 1, NULL, '', 1, NULL, 1),
(20, 0, '', '', '', NULL, NULL, '', NULL, NULL, 0),
(21, 1, '4234234', 'ប្រុស', '34', 0, NULL, '423423423', 1, NULL, 0),
...
(32, 0, '', '', '', NULL, NULL, '', NULL, NULL, 0),
(33, 0, '', '', '', NULL, NULL, '', NULL, NULL, 0),
(34, 0, '', '', '', NULL, NULL, '', NULL, NULL, 0),
(35, 0, '', '', '', NULL, NULL, '', NULL, NULL, 0),
(36, 0, '', '', '', NULL, NULL, '', NULL, NULL, 0),
(37, 0, '', '', '', NULL, NULL, '', NULL, NULL, 0),
(38, 0, '', '', '', NULL, NULL, '', NULL, NULL, 0),
(39, 0, '', '', '', NULL, NULL, '', NULL, NULL, 0),
(40, 0, '', '', '', NULL, NULL, '', NULL, NULL, 0),
(41, 0, '', '', '', NULL, NULL, '', NULL, NULL, 0),
(42, 0, '', '', '', NULL, NULL, '', NULL, NULL, 0);

-- --------------------------------------------------------

--
-- Table structure for table `case_court`
--

DROP TABLE IF EXISTS `case_court`;
CREATE TABLE IF NOT EXISTS `case_court` (
  `courtid` int(11) NOT NULL AUTO_INCREMENT,
  `caseregisid` int(11) DEFAULT NULL,
  `courtname` varchar(45) DEFAULT NULL,
  `letter_req_no` varchar(45) DEFAULT NULL,
  `letter_req_date` date DEFAULT NULL,
  `is_poor` tinyint(1) DEFAULT '0',
  `interview_date` date DEFAULT NULL,
  `interview_note` varchar(100) DEFAULT NULL,
  `isaprove` tinyint(1) DEFAULT '0',
  `aprove_money_no` varchar(30) DEFAULT NULL,
  `aprove_money_date` date DEFAULT NULL,
  `aprove_by_who` varchar(45) DEFAULT NULL,
  `aprove_money_total` double DEFAULT NULL,
  `aporve_ispaid` tinyint(1) DEFAULT '0',
  `appove_mission_no` varchar(45) DEFAULT NULL,
  `aprove_mission_date` date DEFAULT NULL,
  `case_request_note` varchar(145) DEFAULT NULL,
  PRIMARY KEY (`courtid`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `case_court`
--

INSERT INTO `case_court` (`courtid`, `caseregisid`, `courtname`, `letter_req_no`, `letter_req_date`, `is_poor`, `interview_date`, `interview_note`, `isaprove`, `aprove_money_no`, `aprove_money_date`, `aprove_by_who`, `aprove_money_total`, `aporve_ispaid`, `appove_mission_no`, `aprove_mission_date`, `case_request_note`) VALUES
(1, 1, 'កណ្តាល', '34343', '2018-05-03', 1, '2018-05-05', '3453453', 1, '', '0000-00-00', '', 0, 0, '', '0000-00-00', '');

-- --------------------------------------------------------

--
-- Table structure for table `case_court_appointedlawyer`
--

DROP TABLE IF EXISTS `case_court_appointedlawyer`;
CREATE TABLE IF NOT EXISTS `case_court_appointedlawyer` (
  `appointed_di` int(11) NOT NULL AUTO_INCREMENT,
  `case_court_id` int(11) DEFAULT NULL,
  `lawyer_id` int(11) DEFAULT NULL,
  `lawyer_name` varchar(45) DEFAULT NULL,
  `aprove_appointed_no` varchar(45) DEFAULT NULL,
  `aprove_appointed_date` date DEFAULT NULL,
  `isrespone` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`appointed_di`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `case_court_appointedlawyer`
--

INSERT INTO `case_court_appointedlawyer` (`appointed_di`, `case_court_id`, `lawyer_id`, `lawyer_name`, `aprove_appointed_no`, `aprove_appointed_date`, `isrespone`) VALUES
(1, 1, NULL, 'កុយ ពន្លឺ', '454', '2018-05-04', 0),
(2, 1, NULL, 'បាន យ៉ាន់ណូ', '454', '2018-05-11', 0);

-- --------------------------------------------------------

--
-- Table structure for table `case_filestore`
--

DROP TABLE IF EXISTS `case_filestore`;
CREATE TABLE IF NOT EXISTS `case_filestore` (
  `file-id` int(11) NOT NULL AUTO_INCREMENT,
  `case_id` int(11) NOT NULL,
  `file_descript` varchar(100) DEFAULT NULL,
  `file_name` varchar(100) DEFAULT NULL,
  `file_belongto` varchar(100) DEFAULT NULL,
...
(8, '001', '2018-02-03', 'រដ្ឋប្បវេណី', '5345643', 'តុលាការ', NULL, '42323'),
(9, '5488', '2018-02-01', 'ពាណិជ្ជកម្ម', '546546', 'កូនក្តី', NULL, '23423423423424'),
(10, '5488', '2018-02-01', 'ផ្សេងៗ', '', 'កូនក្តី', NULL, '23423423423424'),
(11, '1222', '2018-01-02', 'ពាណិជ្ជកម្ម', '53453453', 'កូនក្តី', NULL, '345345'),
(12, '12226', '2018-01-02', 'រដ្ឋប្បវេណី', '', 'នគរបាល', NULL, ''),
(13, '212226', '2018-01-02', 'ព្រហ្មទណ្ឌ', '', 'កូនក្តី', NULL, ''),
(14, 'P0001', '2018-01-03', 'ព្រហ្មទណ្ឌ', '', 'អាជ្ញាធរស៊ីវិល', NULL, 'sdf434'),
...
(18, '', '0000-00-00', 'ពាណិជ្ជកម្ម', '454', 'អាវុធហត្ថ', NULL, ''),
