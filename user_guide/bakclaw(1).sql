...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 05, 2018 at 12:03 PM
...
CREATE TABLE IF NOT EXISTS `case_client` (
  ...
  `clientage` varchar(50) NOT NULL,
  `adults` bit(10) NOT NULL,
  `minor` bit(10) NOT NULL,
  `clientnote` varchar(150) NOT NULL,
  `isclient` bit(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `case_regis` (
  ...
  `typeofcase` varchar(50) NOT NULL,
  `accusations` varchar(150) NOT NULL,
  `getfrom` varchar(50) NOT NULL,
  `createdateregist` date NOT NULL,
  `casenote` varchar(150) NOT NULL,
  PRIMARY KEY (`caseid`)
...
(1, '0001/0988', '2018-03-07', 'ព្រហ្មទណ្ឌ', 'ឈ្មោះបទល្មើស តាមមាត្រា ច្បាប់', 'តុលាការ', '2018-03-27', '២៣៤២៣៤២៤២៤២'),
...
(4, '0004', '2018-03-11', 'ពាណិជ្ជកម្ម', 'ប៉ុនប៉ងលួច', 'នគបាល', '2018-03-20', '៤២៣២៣៤');
...
(1, 'Ban Yanno', 'srey', 85, 'ypiopi', '01238373', 3423),
